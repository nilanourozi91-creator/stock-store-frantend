    ...
    <header className="sticky top-0 z-50 w-full border-b bg-white/90 backdrop-blur-md">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden items-center gap-2 lg:flex">
          ...
          <button
            aria-label="Search"
            className="rounded-full p-2.5 text-gray-600 transition hover:bg-gray-100 hover:text-purple-600"
          >
          ...
          <Link
            ...
            className="relative rounded-full p-2.5 text-gray-600 transition hover:bg-gray-100 hover:text-purple-600"
          >
          ...
          <Link
            href="/login"
            className="ml-2 flex items-center gap-2 rounded-full border border-gray-200 px-4 py-2 text-sm font-medium text-gray-700 transition hover:border-purple-200 hover:bg-purple-50 hover:text-purple-600"
          >
        ...
        <div className="border-t bg-white lg:hidden">
          <nav className="mx-auto flex max-w-7xl flex-col px-4 py-5 sm:px-6">
            ...
            <Link
              ...
              className="rounded-lg px-4 py-3 text-sm font-medium text-purple-600 hover:bg-purple-50"
            >
              Home
            </Link>
            ...
            <div className="mt-3 grid grid-cols-2 gap-3 border-t pt-4">
              ...
              <Link
                href="/login"
                onClick={() => setOpen(false)}
                className="flex items-center justify-center gap-2 rounded-full border border-gray-200 py-2.5 text-sm font-medium"
              >
                <User className="h-4 w-4" />
                Login
              </Link>
              ...
              <Link
                href="/register"
                onClick={() => setOpen(false)}
                className="rounded-full bg-purple-600 py-2.5 text-center text-sm font-semibold text-white"
              >
                Get Started
              </Link>
