...
import RatingProducts from '@/components/share/rating';
 ...
 async function Singleprodect({params}:{params:Promise<{id:number}>}) {
  ...
  return (
    ...
    //         <ProdectImg list={list.data.imgall}/>
    //       </div>
    //       <div className='col-span-2 grid gap-y-10  pt-4 pl-12 h-fit'>
    //         <span className='text-muted-foreground text-sm'>{list.data.name}</span>
    //         <div className='flex flex-col md:gap-y-8 gap-y-4'>
    //         <h1 className='text-2xl font-bold'>{list.data.name}</h1>
    //           <div className='bg-green-400 p-3 rounded-full w-fit'>
    //             {/* <ProdectP price={list.price}></ProdectP> */}
    //              {/* <ProdectP price={list.price.toString()}/> */}
    //           </div>
    //         </div>
    ...
    //      {/* <ReviewCard prodect={productReviews}/> */}
    //      {/* <FormReview/> */}
    //     </div>  
    // </div>
